...
class PageController extends Controller
{
    ...
    public function index()
    {
    	...
    	return \View::make('manage-pages.index',$data);
    }
    ...
    public function create()
    {
    	...
    	if($v->passes()){
    		...
    		try{
    			...
    			$edition_pages_tables = \App\Epaper::GetTables('edition_pages');
    ...
    public function ajaxEditPage($publish_date, $page_id)
    {
    	...
    	return \View::make('manage-pages.ajax-page-update',$data);
    }
   ...
   public function publishPages()
   {
   	...
   	return \View::make('manage-pages.publish',$data);
   }
