		...
		<div class="col-md-4">
			...
			<div class="box box-primary">
				<div class="box-body box-profile">
					...
					<img class="profile-user-img img-responsive img-circle" src="{{asset('assets/images/avatars/'.\Auth::user()->user_image)}}" alt="User Avatar">
					@else
					<img class="profile-user-img img-responsive img-circle" src="{{asset('assets/images/avatars/default_avatar.png')}}" alt="User Avatar">
					@endif
