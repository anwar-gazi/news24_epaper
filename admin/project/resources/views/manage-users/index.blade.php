						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align: middle;">
									...
									<img src="{{asset('assets/images/avatars/'.$list->user_image)}}" style="height: 40px;width: 40px;border-radius: 100%">
									@else
									<img src="{{asset('assets/images/avatars/default_avatar.png')}}" style="height: 40px;width: 40px;border-radius: 100%">
									@endif
								</td>
