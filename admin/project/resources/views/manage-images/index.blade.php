...
@push('page-css')
<link rel="stylesheet" href="{{asset('assets/image-mapping/css/jquery.Jcrop.min.css')}}">
<style type="text/css">
...
<script src="{{asset('assets/image-mapping/js/jquery.Jcrop.min.js')}}"></script>
<script src="{{asset('assets/image-mapping/js/app.js')}}"></script>
