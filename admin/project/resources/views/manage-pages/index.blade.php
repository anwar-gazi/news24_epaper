...
<link rel="stylesheet" type="text/css" href="{{asset('assets/plugins/multiselect-checkbox/bootstrap-multiselect.css')}}">
<style type="text/css">
				...
				<table class="table table-bordered table-hover table-text-center">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
							@php $editions=\App\Page::PageEdition($list->publish_date, $list->id); @endphp
...
<script src="{{asset('assets/plugins/multiselect-checkbox/bootstrap-multiselect.js')}}"></script>
<script type="text/javascript">
	$(function() {
