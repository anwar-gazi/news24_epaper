		...
		<div class="col-md-12 col-sm-12 related_image_display" >
			...
			<center>
				<ul >
					...
					<li>
					<input type="radio" name="related_image_id" id="cb<?php echo e($key+1); ?>" value="<?php echo e($related_image_list->id); ?>" />
						<label for="cb<?php echo e($key+1); ?>"><img src="<?php echo e($up_dir.$uploads_path.date('Y',strtotime($image_date)).'/'.date('m',strtotime($image_date)).'/'.date('d',strtotime($image_date)).'/images/'.$related_image_list->image); ?>" class="image-responsive" style="border: 1px solid black"></label>
					</li>
					<?php endforeach; ?>
				</ul>
			</center>
