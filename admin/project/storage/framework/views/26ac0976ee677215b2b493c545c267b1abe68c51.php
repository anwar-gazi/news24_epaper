			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<form action="<?php echo e(url('/up_details')); ?>" method="post" enctype="multipart/form-data">
						...
						<p class="text-muted">
							<textarea name="epapper_name"class="form-control"><?php echo e($user_info->epapper_name); ?></textarea>
						</p>
						...
						<p class="text-muted">
							<textarea name="meta_description"class="form-control"><?php echo e($user_info->meta_description); ?></textarea>
						</p>
						...
						<p class="text-muted">
							<textarea name="meta_tag"class="form-control"><?php echo e($user_info->meta_tag); ?></textarea>
						</p>
						...
						<p class="text-muted">
							<textarea name="facebook"class="form-control"><?php echo e($user_info->facebook); ?></textarea>
						</p>
						
																								<strong><i class="fa fa-twitter"></i>Twitter Link</strong>

						<p class="text-muted">
							<textarea name="twitter"class="form-control"><?php echo e($user_info->twitter); ?></textarea>
						</p>
						...
						<p class="text-muted">
							<textarea name="youtube"class="form-control"><?php echo e($user_info->youtube); ?></textarea>
						</p>
