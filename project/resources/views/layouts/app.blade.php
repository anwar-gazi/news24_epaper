...
<body id="body">
		...
		<div class="header-div">
			<div class="header-div">
							...
							<td>
								<div class="date text-left" style="margin-top: 2px"> 
									...
									<p style="color: black;font-size: 17px">
				                      অনলাইন ভার্সন দেখতে ক্লিক করুন <a href="<?php echo $epaper_het->online; ?>">অনলাইন ভার্সন</a></p>
								</div>
							</td>
							<td>
								<div class="social-icon" style="text-align: right;margin-top: 3px">
									<ul class="list-unstyled" style="height: 32px;margin-left: 0;padding-left: 0">
										<li class="fb btn" ><a href="<?php echo $epaper_het->facebook; ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
										</li>
										<li class="twit btn"><a href="<?php echo $epaper_het->twitter; ?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
										</li>
										<li class="gplus btn"><a href="<?php echo $epaper_het->youtube; ?>" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
										</li>
									</ul>
								</div>
							</td>
				...
				<!-- end epaper_header_top_ad -->
					...
					<a href="{{url('/')}}"><img src="{{asset('admin/assets/images/logo/')}}/<?php echo $epaper_het->logo; ?>" style="width: 300px"></a>
	...
	@php $epaper_header_top_ad = \App\Epaper::GetAdvertisement('modal_top'); @endphp
				...
				<div class="row-div" style="overflow: hidden;">
                    ...
                    <div id="img" style="position: absolute; border: 1px solid #dee2e6!important; width: 400px; height: auto; z-index: 100; background-color: white; display: none; padding: 10px; padding-bottom: 50px;">
                        
                        <span class="close-button" onclick="closeDiv()"
                        style="position: absolute; top: 5px; left: 5px; cursor:pointer; font-size: 16px; padding: 2px 5px; border: 1px solid gray; border-radius: 3px; background-color: white;"
                        >X</span>
                        
                        <div id="img1" style="display: flex; justify-content: center; align-items: center; margin-top: 50px; ">
                            <img class="img1" src="" />
                        </div>
                        <div id="img2" style="display: flex; justify-content: center; align-items: center; margin-top: 50px;">
                            <img class="img2" src="" />
                        </div>
                    </div>
					...
					<div class="footer-contend" style="padding: 3px; padding-bottom: 10px">
						...
						<div style="width: 100%;" class="footer_texts">
							<table style="width: 100%">
								<tr>
									<td width="40%"><a href="{{url('/')}}"><p class="footerLogo" style="padding-left: 10px">
										<img src="{{asset('admin/assets/images/logo/')}}/<?php echo $epaper_het->logo; ?>" style="width: 250px"></p></a>
									</td>
									<td width="10%">
						...
						<p style="font-size: 14px;color:black;border-top:1px solid #636363;margin-top: 1px;margin-bottom: 2px;padding-left: 0px">
						    <span style="white-space: pre-line; float: left"><?php echo $epaper_het->copyright; ?></span>

						    <span style="display: none; white-space: pre-line; float: right">সকল কারিগরী সহযোগিতায় <a href="https://www.doptor-design.com.bd">Doptor ডিজাইন</a></span>
						</p>
