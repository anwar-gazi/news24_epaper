			...
			<table width="100%" class="modal_table">
				<tr>
					...
					<td class="text-center"> 
						<p>
							<a href="{{url('/')}}"><img src="{{asset('admin/assets/images/logo/')}}/<?php echo $info->logo; ?>" style="height: 50px;padding: 5px 0px" ></a>
						</p>
					</td>
		...
		<div class="modal-body text-center" style="padding: 20px;">
			...
			<div style="margin-top: 20px;margin-right:auto;padding-bottom: 20px">
				...
				<div style="float: left;">
					...
					<button type="button" style="background-color: #25D366;border-radius: 50%;padding: 5px 9px 5px 9px"  class="btn btn-default share_on_whatsapp"><i class="fa fa-whatsapp" style="color: white" aria-hidden="true"></i></button>
		...
		<div class="modal-footer" >
			<div style="width: 100%;" class="footer_texts">
				<table style="width: 100%">
					<tr>
						<td><div class="footer" style="text-align: center !important;padding-left: 10px">
 ...
 <script type="text/javascript">
 	function printDiv(bangla_date) 
 	{
 		...
 		if(related_image_link != ''){
 			newWin.document.write('<html><body onload="window.print()">'+'<center><img src="{{asset("assets/images/logo1.png")}}" style="height:100px;" />'+'<p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">'+bangla_date+'</p>'+'<img src='+main_image+' />'+'</center></body>'+'<body><center>'+'<img src='+related_image+' /> <br> <p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">' + footer_text + '</p>'+'</center></body>'+'</html>');
 		}else{
 			newWin.document.write('<html><body onload="window.print()">'+'<center><img src="{{asset("assets/images/logo1.png")}}" style="height:100px;" />'+'<p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">'+bangla_date+'</p>'+'<img src='+main_image+' /> <br> <p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">' + footer_text + '</p>'+'</center></body></html>');
 		}
