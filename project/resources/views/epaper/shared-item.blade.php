...
<head>
	...
	<title>epaper.netrohat.com</title>
	<meta name="Author" content="Mizanur Rahman" />
	<meta name="Developed By" content="Mizanur Rahman" />
	<meta name="Developer" content="Mizanur Rahman" />
...
<body>
	...
	<script type="text/javascript">
		function printDiv(bangla_date) 
		{
			...
			if(related_image_link != ''){
				newWin.document.write('<html><body onload="window.print()">'+'<center>djjsd<img src="{{asset("assets/images/logo1.png")}}" style="height:4px;width:20px;" />'+'<p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">'+bangla_date+'</p>'+'<img src='+main_image+' />'+'</center></body>'+'<body><center>'+'<img src='+related_image+' />'+'</center></body>'+'</html>');
			}else{
				newWin.document.write('<html><body onload="window.print()">'+'<center>dhbd<img src="{{asset("assets/images/logo1.png")}}" style="height:4px;width:20px;" />'+'<p style="text-align:center;border-top:1px solid black;border-bottom:1px solid black;padding:5px;font-size:13px">'+bangla_date+'</p>'+'<img src='+main_image+' />'+'</center></body></html>');
			}
	...
	<script type="text/javascript">
		$('.close').click(function(){
			location.href = 'https://www.facebook.com/mizan1400';
		});
	</script>
